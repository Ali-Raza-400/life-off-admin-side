...
function PrivateLayout({ children }: LayoutProps) {
	...
	const shouldHideLayout = pathname.includes("/single-store") || pathname.includes("/single-category") || pathname.includes(PATH.ALL_CATEGORY) || pathname.includes(PATH.ALL_BLOG) || pathname.includes('/single-blog/')|| pathname.includes('/single-event')|| pathname.includes(PATH.TERMS_CONDITIONS);

...
export default function DealCard({ discount, type, brand, description, verified, expiry, logo }: DealCardProps) {
  return (
    <div className="border rounded-lg overflow-hidden">
      <div className="p-4 bg-white">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center">
            <img src={logo || "/placeholder.svg"} alt={`${brand} logo`} width={40} height={40} className="mr-2" />
          </div>
        </div>
        <div className="mb-4">
